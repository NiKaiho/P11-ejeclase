...
typedef struct _frame
{
	...
	float rotRodIzq, rotRodDer;
	float rotInc, rotRodDerInc;
	float giroMonito;
	float giroMonitoInc;
	float giroBrazoIzq, giroBrazoIzq2;// VALOR INICIAL
	float giroBrazoIzqInc, giroBrazoIzqInc2;//VALOR INCREMENTO
	float giroBrazoDer, giroBrazoDer2;// VALOR INICIAL
	float giroBrazoDerInc, giroBrazoDerInc2;//VALOR INCREMENTO
	float giroPieIzq, giroPieIzq2;// VALOR INICIAL
	float giroPieIzqInc, giroPieIzqInc2;//VALOR INCREMENTO
	float giroPieDer, giroPieDer2;// VALOR INICIAL
	float giroPieDerInc, giroPieDerInc2;//VALOR INCREMENTO
...
void resetElements(void)
{
	...
	giroPieIzq = KeyFrame[0].giroPieIzq;
	giroPieDer = KeyFrame[0].giroPieDer;
	giroBrazoIzq2 = KeyFrame[0].giroBrazoIzq2;
	giroBrazoDer2 = KeyFrame[0].giroBrazoDer2;
	giroPieIzq2 = KeyFrame[0].giroPieIzq2;
	giroPieDer2 = KeyFrame[0].giroPieDer2;
}
...
void interpolation(void)
{
	...
	KeyFrame[playIndex].giroPieIzqInc = (KeyFrame[playIndex + 1].giroPieIzq - KeyFrame[playIndex].giroPieIzq) / i_max_steps;
	KeyFrame[playIndex].giroPieDerInc = (KeyFrame[playIndex + 1].giroPieDer - KeyFrame[playIndex].giroPieDer) / i_max_steps;
	KeyFrame[playIndex].giroBrazoIzqInc2 = (KeyFrame[playIndex + 1].giroBrazoIzq2 - KeyFrame[playIndex].giroBrazoIzq2) / i_max_steps;
	KeyFrame[playIndex].giroBrazoDerInc2 = (KeyFrame[playIndex + 1].giroBrazoDer2 - KeyFrame[playIndex].giroBrazoDer2) / i_max_steps;
	KeyFrame[playIndex].giroPieIzqInc2 = (KeyFrame[playIndex + 1].giroPieIzq2 - KeyFrame[playIndex].giroPieIzq2) / i_max_steps;
	KeyFrame[playIndex].giroPieDerInc2 = (KeyFrame[playIndex + 1].giroPieDer2 - KeyFrame[playIndex].giroPieDer2) / i_max_steps;
}
...
void monito()
{
	...
	glRotatef(giroBrazoDer, 0, 1, 0);
	glRotatef(giroBrazoDer2, 0, 0, 1);
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	///////////////////////////////////////////////////////////////
	/*Aqui ponen los valores de los cuadros que quieren*/
	KeyFrame[0].posX = 0.0;
	KeyFrame[0].posY = 2.5;
	KeyFrame[0].posZ = -3.5;
	...
	KeyFrame[0].giroPieIzq = 0;
	KeyFrame[0].giroPieDer = 0;
	KeyFrame[0].giroBrazoIzq2 = 0;
	...
	KeyFrame[1].posY = 2.5;
	KeyFrame[1].posZ = -3.5;
	KeyFrame[1].rotRodDer = 54;
	KeyFrame[1].rotRodIzq = 0;
	KeyFrame[1].giroMonito = 61;
	KeyFrame[1].giroBrazoIzq = 98;
	KeyFrame[1].giroBrazoDer = -98;
	KeyFrame[1].giroPieIzq = 0;
	KeyFrame[1].giroPieDer = 0;
	KeyFrame[1].giroBrazoIzq2 = 46;
	KeyFrame[1].giroBrazoDer2 = 64;
	KeyFrame[1].giroPieIzq2 = -28;
	KeyFrame[1].giroPieDer2 = 16;

	KeyFrame[2].posX = 0.0;
	KeyFrame[2].posY = 2.5;
	KeyFrame[2].posZ = -3.5;
	KeyFrame[2].rotRodDer = -5;
	KeyFrame[2].rotRodIzq = 70;
	KeyFrame[2].giroMonito = -73;
	KeyFrame[2].giroBrazoIzq = 98;
	KeyFrame[2].giroBrazoDer = -92;
	KeyFrame[2].giroPieIzq = -97;
	KeyFrame[2].giroPieDer = 13;
	KeyFrame[2].giroBrazoIzq2 = -62;
	KeyFrame[2].giroBrazoDer2 = -74;
	KeyFrame[2].giroPieIzq2 = -28;
	KeyFrame[2].giroPieDer2 = 22;

	KeyFrame[3].posX = 0.0;
	KeyFrame[3].posY = 2.5;
	KeyFrame[3].posZ = -3.5;
	KeyFrame[3].rotRodDer = 20;
	KeyFrame[3].rotRodIzq = 0;
	KeyFrame[3].giroMonito = 0.0;
	KeyFrame[3].giroBrazoIzq = 0.0;
	KeyFrame[3].giroBrazoDer = 0.0;
	KeyFrame[3].giroPieIzq = -67;
	KeyFrame[3].giroPieDer = 71;
	KeyFrame[3].giroBrazoIzq2 = 79;
	KeyFrame[3].giroBrazoDer2 = 87;
	KeyFrame[3].giroPieIzq2 = 22;
	KeyFrame[3].giroPieDer2 = -28;

	KeyFrame[4].posX = 0.0;
	KeyFrame[4].posY = 2.5;
	KeyFrame[4].posZ = -3.5;
	KeyFrame[4].rotRodDer = -1;
	KeyFrame[4].rotRodIzq = 0;
	KeyFrame[4].giroMonito = 0.0;
	KeyFrame[4].giroBrazoIzq = 92;
	KeyFrame[4].giroBrazoDer = -101;
	KeyFrame[4].giroPieIzq = -11;
	KeyFrame[4].giroPieDer = 5;
	KeyFrame[4].giroBrazoIzq2 = -74;
	KeyFrame[4].giroBrazoDer2 = -96;
	KeyFrame[4].giroPieIzq2 = -28;
	KeyFrame[4].giroPieDer2 = 22;
	...
	KeyFrame[5].giroBrazoIzq = 0;
	KeyFrame[5].giroBrazoDer = 0;
	KeyFrame[5].giroPieIzq = 0;
	KeyFrame[5].giroPieDer = 0;
	KeyFrame[5].giroBrazoIzq2 = 0;
	KeyFrame[5].giroBrazoDer2 = 0;
	KeyFrame[5].giroPieIzq2 = 0;
	KeyFrame[5].giroPieDer2 = 0;
	////////////////////////////////////////////////////////////////////////////
...
void animacion()
{
	...
	if (play)
	{
		...
		else
		{
			...
			giroPieIzq += KeyFrame[playIndex].giroPieIzqInc;
			giroPieDer += KeyFrame[playIndex].giroPieDerInc;
			giroBrazoIzq2 += KeyFrame[playIndex].giroBrazoIzqInc2;
			giroBrazoDer2 += KeyFrame[playIndex].giroBrazoDerInc2;
			giroPieIzq2 += KeyFrame[playIndex].giroPieIzqInc2;
			giroPieDer2 += KeyFrame[playIndex].giroPieDerInc2;
...
void keyboard(unsigned char key, int x, int y)  // Create Keyboard Function
{
	...
	case 'l'://reproduccion de la grabacion
	case 'L':
		if (play == false)
		{
	...
	case 'Z':
		...
		printf("posicion X: %f \n", posX);
		printf("posicion Y: %f \n", posY);
		printf("posicion rotRodIzq: %f \n", rotRodIzq);
		printf("posicion rotRodDer: %f \n", rotRodDer);
		printf("posicion giroMonito: %f \n", giroMonito);
		printf("posicion giroPieDer: %f \n", giroPieDer);
		printf("posicion giroPieIzq: %f \n", giroPieIzq);
		printf("posicion giroBrazoDer: %f \n", giroBrazoDer);
		printf("posicion giroBrazoIzq: %f \n", giroBrazoIzq);
		printf("posicion giroBrazoDer2: %f \n", giroBrazoDer2);
		printf("posicion giroBrazoIzq2: %f \n", giroBrazoIzq2);
		printf("posicion giroPieDer2: %f \n", giroPieDer2);
		printf("posicion giroPieIzq2: %f \n", giroPieIzq2);
